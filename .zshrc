...
# Config for obs (Obsidian notes browser)
export PATH=$PATH:/home/linuxbrew/.linuxbrew/Cellar/obs

# Config for The Fuck
eval $(thefuck --alias)

# Config For CLITools Aliases
export PATH=$PATH:/home/simon/.CLITools
alias vol="~/.CLITools/pulsemixer"
